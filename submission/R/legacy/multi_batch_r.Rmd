...
filelocation<-params$filelocation
  filelocation<-"/home/anne/Masterarbeit/batch_test/result_true/biogrid_clu/biogrid/"
...
fwrite(annotation_table, file.path(filelocation, "annotation_table.tsv"), sep = "\t")
fwrite(network_jaccard, file.path(filelocation, "jaccard_table.tsv"), sep = "\t")
```
```{r, echo=F}
...
fwrite(count, file.path(filelocation, "individual_overlaps.tsv"), sep = "\t")
