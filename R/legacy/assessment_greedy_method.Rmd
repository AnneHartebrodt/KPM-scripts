---
title: "Greedy Approach Assesment"
...
```{r}
fdr<-fread("~/Masterarbeit/Testing/out_new/1531922997666/thresholds.txt")
fdr$V1<-1:nrow(fdr)
...
f1 <-fread("/home/anne/Documents/Master/MA/Testing/out_new/1531922997666/file.graph")
f1[,.N, by = V1]
...
```{r}
pval<-fread("/home/anne/Documents/Master/MA/Testing/out_new/1531922997666/file.stat")
pval[V2<0.1]
```
...
```{r}
nodes<-fread("/home/anne/Documents/Master/MA/Testing/out_new/1531922997666/file.nodes")
nodes[, .N, by=V2]
```
...
# Node distribution
```{r}
nn<-fread("/home/anne/Documents/Master/MA/Testing/out_new/1531922997666/nodeDist.txt", header= FALSE, sep = "\t", fill = T)
...
```{r}
teststats<-fread("/home/anne/Documents/Master/MA/Testing/out_new/1531922997666/p_sam.txt", header= FALSE, sep = "\t")
